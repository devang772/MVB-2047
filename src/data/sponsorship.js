...
// Categorized Tiered Sponsors Structure
export const tieredSponsors = {
  ...
  official: [
    ...
    {
      id: 'daroga',
      name: 'M/S Daroga Pradhan',
      shortName: 'M/S DAROGA PRADHAN',
      logo: null,
      tier: 'Official Sponsor',
      tierCategory: 'Official',
      website: '#',
...
// All sponsors list for Hero section rotation with exact tier badges
...
export const otherSponsors = [
  ...tieredSponsors.gold,
  ...tieredSponsors.silver,
  ...tieredSponsors.official.filter(s => !['indukuri', 'aimil', 'normet'].includes(s.id)),
];
